...
client.on("message", (message) => {
    ...
    if (command === prefix + "bomdia") {
        ...
        if (date.getHours() - 3 >= 13 && date.getHours() - 3 < 18) {
            message.channel.send("Meio atrasado não? Já são " + date.getHours() - 3 + " horas! O correto seria boa tarde! XD");
        }
        else if (date.getHours() - 3 > 18) {
            message.channel.send("Olha, seria bom vc olhar pra janela ou pro relógio. Já são " + date.getHours() - 3 + " horas! O correto seria boa noite! XD");
        }
        else if (date.getHours() - 3 < 5 && date.getHours() - 3 > 00) {
            message.channel.send("Boa madrugada! Agora vai dormir pq já são " + date.getHours() - 3 + " horas!");
        }
    ...
    if (command === prefix + "boatarde") {
        ...
        if (date.getHours() - 3 >= 6 && date.getHours() - 3 < 12) {
    ...
    if (command === prefix + "boanoite") {
        ...
        if (date.getHours() - 3 >= 6 && date.getHours() - 3 < 12) {
            message.channel.send("Olha, já amanheceu viu XD. são " + date.getHours() - 3 + " horas! Suspeito q  vc tenha virado a noite jogando? XD");
        }
        else if (date.getHours() - 3 === 00) {
            message.channel.send("meia-noite.... Seria um novo dia com bom dia? ou ainda boa noite? dianoitedianoitedianoitedianoitedianoitedianoitedianoitedianoitedianoitedianoitedianoitedianoitedianoitedianoitedianoitedianoitedianoitedianoitedianoitedianoite \n **RangeError:** Maximum call stack size exceeded");
        }
        ...
        else if (date.getHours() - 3 > 12 && date.getHours() - 3 < 18) {
            message.channel.send("Meio cedo pra boa noite, não? ainda são " + date.getHours() - 3 + " horas. Como já diz o sistema de conexão da PSN : Tente novamente mais tarde");
        }
        else {
            message.channel.send(replies[Math.floor(Math.random() * replies.length)]);
        }
