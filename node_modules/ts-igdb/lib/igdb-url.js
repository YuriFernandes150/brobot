...
class IGDBUrl {
    constructor() {
        this.API_URL = 'https://api-endpoint.igdb.com';
    }
    /**
    ...
    queryString(options) {
        ...
        for (let param in options) {
            ...
            switch (param) {
                case 'search':
                    params.push(`${param}=${encodeURI(options[param])}`);
                    break;
                case 'expand':
                case 'fields':
                    params.push(`${param}=${options[param].join(',')}`);
                    break;
                case 'limit':
                case 'offset':
                ...
                case 'filters':
                    ...
                    break;
                case 'order':
                    const field = options[param].field;
                    const direction = options[param].direction;
                    const subfilter = options[param].subfilter;
