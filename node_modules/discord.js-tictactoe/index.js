...
module.exports.run = async (client, prefix,embed_color, start_command) => {
    client.on('message', async message => {
      ...
      var bkg = await loadImage("https://cdn.discordapp.com/attachments/494191132318892043/630859748165681162/plansza.png");
      ctx.drawImage(bkg, 0, 0, canvas.width, canvas.height);
      //variables(dialogaty)
      var o = await loadImage("https://cdn.discordapp.com/attachments/494191132318892043/630859747385540659/o.png");
      var x = await loadImage("https://cdn.discordapp.com/attachments/494191132318892043/630859749390549005/x.png");
      var line = await loadImage("https://cdn.discordapp.com/attachments/494191132318892043/630859741106667560/linia.png")
      var lineHorizontal  = await loadImage("https://cdn.discordapp.com/attachments/494191132318892043/630859745414086658/liniaHorizontal.png")
      var pozycje = {
        a1: [0, 0],
        a2: [360, 0],
        a3: [720, 0],
