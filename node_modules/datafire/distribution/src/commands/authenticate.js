...
var generateToken = function generateToken(project, integration, secOption, accountToEdit, clientAccount) {
  var questions = [];
...
var startOAuthServer = function startOAuthServer(project, integration, secDef, accountToEdit, clientAccount) {
  return new Promise(function (resolve, reject) {
    var server = http.createServer(function (req, res) {
      ...
      function finish(scopes) {
        var url = getOAuthURL(integration, secDef, clientAccount, scopes);
